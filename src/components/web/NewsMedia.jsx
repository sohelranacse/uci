  ...
  return (
    <section className="AboutUsbg px-2">
      <div className="container mx-auto py-24">
        <h1 className="font-[800] text-4xl md:text-[64px] pb-8 md:pb-[61px] md:leading-[29px] text-[#006AB6]">
          News & Media
        </h1>

        {/* row */}
        <Link to="/about" className="pb-[40px] md:grid grid-cols-4 group">
          ...
          <div className="col-span-3 bg-[#7D7E81] text-white pl-[30px] pr-[76px] group-hover:bg-white group-hover:text-[#006AB6] ease-linear duration-200">
            <h3 className="pt-[38px] text-[45px] pb-[13px] font-[800] leading-[38px]">
        ...
        <Link
          to="/"
          className="text-[#006AB6] text-[20px] font-[600] pt-[21px] flex gap-2 leading-[20px] hover:text-[#EE3129] ease-linear duration-300"
        >
